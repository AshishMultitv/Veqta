 ...
 *
 * @deprecated Use GCKLoggerFilter::setLoggingLevel:forClasses: instead.
 */
 ...
 * supported.
 *
 * @deprecated Use GCKLoggerFilter::setLoggingLevel:forFunctions: instead.
 */
 ...
 *
 * @deprecated Use GCKLoggerFilter::addMessagePatterns: with inline (?-i) or (?i) instead.
 *
 */
- (void)addMessagePatterns:(NSArray<NSString *> *)messagePatterns
